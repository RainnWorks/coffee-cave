...
-- CreateTable
CREATE TABLE "public"."pin_login" (
    "id" VARCHAR NOT NULL,
    "pinHash" VARCHAR NOT NULL,
    "pinSalt" VARCHAR NOT NULL,

    CONSTRAINT "pin_login_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "public"."password_login" (
    "id" VARCHAR NOT NULL,
    "passwordHash" VARCHAR NOT NULL,
    "passwordSalt" VARCHAR NOT NULL,

    CONSTRAINT "password_login_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."admin" (
    "id" VARCHAR NOT NULL,
    "email" VARCHAR,
    "passwordLoginId" VARCHAR NOT NULL,
    "credVersion" INTEGER NOT NULL DEFAULT 1,
    "disabledAt" TIMESTAMP(3),
...
-- CreateIndex
CREATE UNIQUE INDEX "staff_pinLoginId_key" ON "public"."staff"("pinLoginId");

-- CreateIndex
CREATE UNIQUE INDEX "admin_passwordLoginId_key" ON "public"."admin"("passwordLoginId");

-- CreateIndex
CREATE UNIQUE INDEX "admin_staffId_key" ON "public"."admin"("staffId");

-- AddForeignKey
ALTER TABLE "public"."staff" ADD CONSTRAINT "staff_pinLoginId_fkey" FOREIGN KEY ("pinLoginId") REFERENCES "public"."pin_login"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."admin" ADD CONSTRAINT "admin_passwordLoginId_fkey" FOREIGN KEY ("passwordLoginId") REFERENCES "public"."password_login"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."restaurant_table" ADD CONSTRAINT "restaurant_table_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "public"."staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."restaurant_table" ADD CONSTRAINT "restaurant_table_closedById_fkey" FOREIGN KEY ("closedById") REFERENCES "public"."staff"("id") ON DELETE SET NULL ON UPDATE CASCADE;
