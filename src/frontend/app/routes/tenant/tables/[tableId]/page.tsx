...
import { groupItems } from "@frontend/lib/basket";
import { useReconciledTableQuery } from "@frontend/lib/table-reconciler";
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="mt-1 flex items-center text-sm text-gray-500">
                  ...
                  <span>
                    {DateTime.fromMillis(activeTab.createdAt ?? Date.now())
                      .setZone(timeZone)
