...
import { useReconciledTablesQuery } from "@frontend/lib/table-reconciler";
import { cn } from "@frontend/lib/utils";
import { useZeroAuth } from "@frontend/zero";
import { ArrowLeft, ChefHat, Plus, Settings } from "lucide-react";
...
export default function TablesPage() {
  ...
  const [allTables] = useReconciledTablesQuery();

  // Filter to only show open tables (closed is false or null)
  const tables = allTables.filter((table) => !table.closed);
